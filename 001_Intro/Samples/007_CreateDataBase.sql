...
(
	...
	FILENAME = 'D:\DataBase\ShopDB.mdf',		-- Указываем Физическое полное имя файла БД.
...
( 
	...
	FILENAME = 'D:\DataBase\ShopDB.ldf',        -- Указываем Физическое полное имя файла журнала БД.
